package games.aSmallWorld.character.enemies;
...
import games.aSmallWorld.character.Entity;
import games.aSmallWorld.character.player.Player;
import games.aSmallWorld.donjon.Cell;
...
public class Enemy extends Entity{
	...
	public Enemy(){
		...
		try {
			imgBattle.add(new Image("images/aSmallWorld/Char_Battle/ennemy1droitestop.png").getScaledCopy(2));
			imgBattle.add(new Image("images/aSmallWorld/Char_Battle/ennemy1droitePD.png").getScaledCopy(2));
			imgBattle.add(new Image("images/aSmallWorld/Char_Battle/ennemy1droitePG.png").getScaledCopy(2));
			imgBattle.add(new Image("images/aSmallWorld/Char_Battle/ennemy1gauchestop.png").getScaledCopy(2));
			imgBattle.add(new Image("images/aSmallWorld/Char_Battle/ennemy1gauchePD.png").getScaledCopy(2));
			imgBattle.add(new Image("images/aSmallWorld/Char_Battle/ennemy1gauchePG.png").getScaledCopy(2));
	...
	public Enemy(Level l){
		imgBattle=new ArrayList<Image>();
		try {
			imgBattle.add(new Image("images/aSmallWorld/Char_Battle/ennemy1droitestop.png"));
			imgBattle.add(new Image("images/aSmallWorld/Char_Battle/ennemy1droitePD.png"));
			imgBattle.add(new Image("images/aSmallWorld/Char_Battle/ennemy1droitePG.png"));
			imgBattle.add(new Image("images/aSmallWorld/Char_Battle/ennemy1gauchestop.png"));
			imgBattle.add(new Image("images/aSmallWorld/Char_Battle/ennemy1gauchePD.png"));
			imgBattle.add(new Image("images/aSmallWorld/Char_Battle/ennemy1gauchePG.png"));
		} catch (SlickException e) {
	...
	public void update(GameContainer arg0, StateBasedGame arg1, int arg2) throws SlickException {
		...
		if(moveTimer <=0){
			...
			//this.getCell();
			move(arg2);
			if(fightFlag) arg1.enterState(0 /* Battle */);
		}
	}
