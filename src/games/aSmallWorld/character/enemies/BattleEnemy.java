...
import games.aSmallWorld.battle.Battle;
import games.aSmallWorld.battle.Brawler;
...
public class BattleEnemy implements Brawler{
	...
	public BattleEnemy(GameContainer arg0,float y){
		...
		try {
			img.add(new Image("images/aSmallWorld/Char_Battle/6.png").getScaledCopy(2));
			img.add(new Image("images/aSmallWorld/Char_Battle/5.png").getScaledCopy(2));
			img.add(new Image("images/aSmallWorld/Char_Battle/4.png").getScaledCopy(2));
			img.add(new Image("images/aSmallWorld/Char_Battle/3.png").getScaledCopy(2));
			img.add(new Image("images/aSmallWorld/Char_Battle/1.png").getScaledCopy(2));
			img.add(new Image("images/aSmallWorld/Char_Battle/2.png").getScaledCopy(2));
	...
	public void returning(int delta){
		if(x<World.longueur*3/4+img.get(0).getWidth()/2){
			x+=0.2*delta;
			if(System.currentTimeMillis()-temp>150){
